...
<body onload="initMap()">
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
         ...
         <img src="{{asset('images.png')}}" style="width:100px"><br><br><span>Admin <br>Management</span>
        </a>
              ...
              <i class="align-middle" data-feather="bar-chart"></i> <span class="align-middle">Golongan</span>
            </a>
				</li>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>Gitasyahfitri</strong></a> &copy;
							</p>
						</div>
