...
.login-wrap{
  ...
  position:relative;
  margin-top: 5%;
  background:url(https://unsplash.com/photos/the-sun-is-setting-over-a-city-with-palm-trees-kThtmOphCs4) no-repeat center;
...
<div class="login-wrap">
  ...
  margin-left: auto;
  margin-right: auto;
  width: 30%;margin-top: 20%;"> --><br><h5 style="color:white;text-align: center;"> SISTEM MANAGEMENT PLN</h5 ><br><br>
        <div class="group">
      ...
      <div class="sign-up-htm">
        <strong><h3 style="color: white;">Sistem Management PLN</h3></strong>
      </div>
    </div>
  </div>
</div>
